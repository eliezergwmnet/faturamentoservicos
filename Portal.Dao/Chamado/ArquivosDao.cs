...
{
    public class ArquivosDao : Functions
    {
        public override IList<T> Select<T>()
        {
            this.procedure = "proc_ChamadoArquivos_Select";
        ...
        {
            this.procedure = "proc_ChamadoArquivos_Insert";
            return base.Insert(obj);
        }
        public override bool? Update(object obj)
        {
            this.procedure = "proc_ChamadoArquivos_Update";
            return base.Update(obj).Value;
        }
        public override bool? Delete(object obj)
        {
            this.procedure = "proc_ChamadoArquivos_Delete";
