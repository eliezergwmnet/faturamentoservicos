...
{
    public class ChamadoDao : Functions
    {
        public override IList<T> Select<T>()
        {
            this.procedure = "proc_Chamado_Select";
        ...
        {
            this.procedure = "proc_Chamado_Insert";
            return base.Insert(obj);
        }
        public override bool? Update(object obj)
        {
            this.procedure = "proc_Chamado_Update";
            return base.Update(obj).Value;
        }
        public override bool? Delete(object obj)
        {
            this.procedure = "proc_Chamado_Delete";
