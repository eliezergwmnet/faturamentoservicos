...
{
    public class ConfiguracaoDao : Functions
    {
        public override IList<T> Select<T>()
        {
            this.procedure = "proc_Configuracao_Select";
        ...
        {
            this.procedure = "proc_Configuracao_Insert";
            return base.Insert(obj);
        }
        public override bool? Update(object obj)
        {
            this.procedure = "proc_Configuracao_Update";
            return base.Update(obj).Value;
        }
        public override bool? Delete(object obj)
        {
            this.procedure = "proc_Configuracao_Delete";
