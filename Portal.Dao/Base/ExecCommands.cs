...
namespace Portal.Dao.Base
{
    public class ExecCommands
    {
        ...
        /// <returns></returns>
        public IList<T> RetornaLista<T>(string Procedure, List<SqlParameter> Parameters)
        {
        ...
        public object ExecutaItem(string Procedures, List<SqlParameter> Parameters)
        {
        ...
        IList<T> ExecComandReturn<T>(System.Data.SqlClient.SqlDataReader dr)
        {
            ...
            if (dr.HasRows)
            {
                ...
                while (dr.Read())
                {
                    ...
                    {
                        if (!prop.GetMethod.ReturnType.Namespace.Contains("Globais.BE") && !prop.GetMethod.ReturnType.Namespace.Contains("Portal.BE") && !prop.GetMethod.ReturnType.Namespace.Contains("Portal.Helper") && !prop.GetMethod.ReturnType.Namespace.Contains("System.Collections.Generic"))
                        {
                            try
                            {
