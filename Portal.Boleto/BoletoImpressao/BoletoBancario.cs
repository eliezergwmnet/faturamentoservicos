...
namespace BoletoNet
{
    ...
    public class BoletoBancario : Control
    {
        ...
        protected static void HtmlOfflineHeader(StringBuilder html, bool usaCSSPDF = false, string titulo = "")
        {
        ...
        public string MontaHtmlEmbedded(bool convertLinhaDigitavelToImage = false, bool usaCSSPDF = false, bool imprimeHeader = true, bool imprimeFooter = true)
        {
            ...
            try
            {
                ...
                var cb = new C2of5i(Boleto.CodigoBarra.Codigo, 1, 65, Boleto.CodigoBarra.Codigo.Length);
        ...
        public byte[] MontaBytesPDF(string html, NReco.PdfGenerator.PageOrientation horientacao = NReco.PdfGenerator.PageOrientation.Default)
        {
            //var converter = new NReco.PdfGenerator.HtmlToPdfConverter();
            //return converter.GeneratePdf(html);

            var htmlToPdf = new NReco.PdfGenerator.HtmlToPdfConverter();
            htmlToPdf.Orientation = horientacao;
            var pdfBytes1 = htmlToPdf.GeneratePdf(html);
            //var pdfBytes2 = htmlToPdf.GeneratePdfFromFile("https://google.com");
            return pdfBytes1;
