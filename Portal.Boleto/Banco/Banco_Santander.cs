    ...
    internal class Banco_Santander : AbstractBanco, IBanco
    {
            ...
            try
            {
                ...
                switch (tipoArquivo)
                {
                    ...
                    case TipoArquivo.CNAB400:
                        _header = GerarHeaderRemessaCNAB400(Convert.ToInt32(numeroConvenio), cedente);
                        break;
        ...
        public string GerarHeaderRemessaCNAB400(int numeroConvenio, Cedente cedente)
        {
            try
            {
                ...
                _header += Utils.FitStringLength("COBRANÇA", 15, 15, ' ', 0, true, true, false);

                //Código de Transmissão ==> 027 - 046
                _header += Utils.FitStringLength("32000324712001300045", 20, 20, '0', 0, true, true, true);
        ...
        public string GerarDetalheRemessaCNAB400(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                _detalhe += boleto.Cedente.ContaBancaria.Agencia.Trim().ToString().PadRight(5, '0');

                //Conta movimento cedente ==> 022 - 029
                _detalhe += boleto.Cedente.Codigo.ToString().PadRight(7, '0');
                //_detalhe += Utils.FitStringLength(boleto.Cedente.Codigo.ToString(), 9, 9, '0', 0, true, true, true);
                ...
                //////    _detalhe += Utils.FitStringLength(boleto.Cedente.ContaBancaria.Conta.Trim().Substring(0, 8), 8, 8, '0', 0, true, true, true); //alterado por diegodariolli - 15/03/2018 - estava cortando um digito
                //////else
                //////{
                    //_detalhe += Utils.FitStringLength(boleto.Cedente.ContaBancaria.Conta.Trim(), 8, 8, '0', 0, true, true, true);
                _detalhe += "1300045".PadLeft(8, '0');
               ///// }
               ...
               //     _detalhe += "0";
                //else
                _detalhe += "40200000000000000000";

                //Percentual multa por atraso % ==> 079 - 082
                //_detalhe += Utils.FitStringLength("02", 4, 4, '0', 0, true, true, true);
                ...
                //var juros = String.Format("{0:0.00}", );

                _detalhe += Utils.FitStringLength(((boleto.ValorBoleto / 30) * Convert.ToDecimal(0.01)).ApenasNumeros(), 13, 13, '0', 0, true, true, true);
                ...
                _detalhe += Utils.FitStringLength(boleto.Sacado.Endereco.CEP.PadLeft(8, '0'), 8, 8, ' ', 0, true, true, true);
        ...
        public string GerarTrailerRemessa400(int numeroRegistro, decimal vltitulostotal)
        {
            try
            {
                ...
                _trailer += Utils.FitStringLength((numeroRegistro - 2).ToString(), 6, 6, '0', 0, true, true, true);
